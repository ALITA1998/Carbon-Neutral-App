...
import com.hui.carbon.adapter.ChartVPAdapter;
import com.hui.carbon.db.DBManager;
import com.hui.carbon.frag_chart.IncomChartFragment;
import com.hui.carbon.frag_chart.OutcomChartFragment;
import com.hui.carbon.utils.CalendarDialog;
...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        ...
        dateTv.setText(year+"年"+month+"月碳中和情况");
//        inTv.setText("共"+incountItemOneMonth+"次吸收,  "+inMoneyOneMonth + "kg");
//        outTv.setText("共"+outcountItemOneMonth+"次排放,  "+outMoneyOneMonth + "kg");
        inTv.setText("共吸收,  "+inMoneyOneMonth + "kg");
        outTv.setText("共排放,  "+outMoneyOneMonth + "kg");
